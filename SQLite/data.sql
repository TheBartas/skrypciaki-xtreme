...
-- Dodanie platform
-- ============================
-- INSERT INTO Streamings (platform_name) VALUES
--     ('Netflix'),
--     ('HBO Max'),
--     ('Disney+'),
--     ('Amazon Prime Video'),
...
-- ============================
-- INSERT INTO Item_Streamings VALUES
--     (1, 1), (1, 4),
--     (2, 1), (3, 2),
--     (4, 1), (4, 3),
--     (5, 4), (6, 1), 
...
-- Dodanie kategorii
-- ============================
-- INSERT INTO Categories (genre) VALUES
--     ('Akcja'),
--     ('Przygodowy'),
--     ('Dramat'),
--     ('Komedia'),
...
-- Uzupełnianie tagów
-- ============================
-- FILMY i SERIALE — jeden duży INSERT
...
-- ============================
-- INSERT INTO Item_Ratings (item_ID, rating_ID) VALUES
--     (1, 1),
--     (2, 2),
--     (3, 3),
--     (4, 4),
